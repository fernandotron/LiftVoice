...
export default function HomeView({
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex flex-col justify-between py-10 sm:py-14 bg-white">
      <div className="container-custom space-y-14">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-5 pt-2">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-zinc-900 tracking-tight leading-[1.1]">
            ...
            {SUPPORTED_LANGUAGES.map((l) => {
              ...
              return (
                <button
                  ...
                  className={`p-3.5 rounded-xl border text-left transition-all duration-150 cursor-pointer flex flex-col justify-between h-28 relative overflow-hidden group ${
                    isPlaying
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className={`font-semibold text-xs ${isPlaying ? 'text-white' : 'text-zinc-900'}`}>{l.nativeName}</div>
                        <div className={`text-[10px] font-mono ${isPlaying ? 'text-zinc-400' : 'text-zinc-400'}`}>{l.code.toUpperCase()} &bull; {l.voice.split(' ')[0]}</div>
                      </div>
                    </div>

                    <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-transform ${
                      isPlaying ? 'bg-white text-zinc-900' : 'bg-zinc-100 text-zinc-600 group-hover:bg-zinc-200'
                    }`}>
                      {isPlaying ? (
                  ...
                  <div className={`flex items-center justify-between pt-2 border-t ${isPlaying ? 'border-zinc-800' : 'border-zinc-100'}`}>
                    {isPlaying ? (
                      ...
                      <span className="text-[10px] text-zinc-400 truncate max-w-[120px]">{l.description}</span>
                    )}

                    <span className={`text-[9px] font-mono uppercase font-medium ${isPlaying ? 'text-zinc-300' : 'text-zinc-400'}`}>
        ...
        {/* Feature Pillars */}
        <div className="border-t border-zinc-200 pt-10 max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
            <div className="p-4 rounded-xl bg-zinc-50/70 border border-zinc-200/80 space-y-1">
              <div className="text-[10px] font-mono text-zinc-400 font-semibold tracking-wider">01 / CAPTURA</div>
              <div className="text-xs font-semibold text-zinc-900">Audio & VAD</div>
            ...
            <div className="p-4 rounded-xl bg-zinc-50/70 border border-zinc-200/80 space-y-1">
              <div className="text-[10px] font-mono text-zinc-400 font-semibold tracking-wider">02 / RECONOCE</div>
              <div className="text-xs font-semibold text-zinc-900">Speech-to-Text</div>
              <div className="text-[11px] text-zinc-500 leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-zinc-50/70 border border-zinc-200/80 space-y-1">
              <div className="text-[10px] font-mono text-zinc-400 font-semibold tracking-wider">03 / TRADUCE</div>
              <div className="text-xs font-semibold text-zinc-900">Multi-Target AI</div>
              <div className="text-[11px] text-zinc-500 leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-zinc-50/70 border border-zinc-200/80 space-y-1">
              <div className="text-[10px] font-mono text-zinc-400 font-semibold tracking-wider">04 / SINTETIZA</div>
              <div className="text-xs font-semibold text-zinc-900">Deepgram & Aura</div>
              <div className="text-[11px] text-zinc-500 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="text-center py-6 text-[11px] text-zinc-400 border-t border-zinc-100 mt-14 font-mono">
